...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        #프로그램시작알림
        self.textEdit.append(QDateTime.currentDateTime().toString("yyyy/MM/dd\nhh:mm:ss") +"ㅣ 프로그램이 시작되었습니다.")
        self.mybot.sendMessage(self.chat_id, text=QDateTime.currentDateTime().toString("yyyy/MM/dd\n hh:mm:ss")  + "ㅣ 프로그램이 시작되었습니다.")
